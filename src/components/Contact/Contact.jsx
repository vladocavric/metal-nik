	...
	return (
		<div className='d-flex eq-width' id='contact'>
			...
			<div className='center d-flex-col p-100'>
				...
				<p>
					{eng ? 'Sales' : 'Prodaja'}: Veselin Nikolić, tel:{' '}
				...
				<p>
					{eng ? 'Technical support' : 'Tehnička podrška'}: dipl. ing. mašinstva Dragan Nikolić, tel:{' '}
					<a href='tel:+381643078215'>0643078215</a>, email:{' '}
